                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                {q.options.map((option: string, oIdx: number) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={oIdx}
                                                            className={`p-3 rounded-xl border text-sm font-bold flex items-center gap-3 transition-all ${isCorrect
                                                                ? "bg-green-500/10 border-green-500/30 text-green-400"
                                                                : "bg-white/5 border-white/10 text-white/60"
                                                                }`}
                                                        >
                                                            <div className={`w-6 h-6 rounded-lg flex items-center justify-center text-xs border ${isCorrect
