...
export default function DeveloperCard() {
    ...
    return (
        <div className="flex justify-center z-50">
            <motion.div
                layout
                className="flex flex-col items-center bg-[#0a0a0a] border border-white/20 p-2.5 px-6 rounded-full shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:border-white/40 transition-all duration-300 cursor-pointer"
